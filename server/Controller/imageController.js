...
//         const { CategoryName, Description, ProductName } = req.body;
//         const imageUrl = req.file ? req.file.path : null; // Ensure this matches the field name

//         // Check if required fields are provided
//         if (!CategoryName || !Description || !ProductName || !imageUrl) {
...
//     // Check if required fields are provided
//     if (!CategoryName || !Description || !ProductName) {
//         return res.status(400).send('All fields are required.');
//     }
...
//             id,
//             { CategoryName, Description, ProductName, ...(imageUrl && { imageUrl }) },
//             { new: true }
//         );
