    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const ordersResponse = await axios.get('/Aridesigner/oders');
            ...
            <div className="Admin-container">
                    ...
                    <ul>
                        <li>
                            <a href="#">
                                ...
                                <div className="title-3" style={{ fontSize: '50px' }}>Rare Fairy</div>
                            </a>
                        </li>
                        <li>
                            <a href="/Home">
                        ...
                        <li>
                            <a href="/Userprofile">
                                ...
                                <div><Link to="/Admin" className="title-2">Users</Link></div>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                ...
                                <div><Link to="/product" className="title-2">Products</Link></div>
                            </a>
                        </li>
                        <li>
                            <a href="/Userprofile">
                ...
                <div className="main">
                    ...
                    <div className="details">
                        ...
                        {/* Uncomment and update this section if you want to display recent customers */}
                        {/* <div className="recentCustomers">
                            ...
                            <table>
                                {users.map((user, index) => (
                                    <tr key={index}>
                                        <td width="60px">
                                            <div className="imgBx"><img src={customer02} alt="Customer" /></div>
                                        </td>
                                        <td>
                                            <h4>{user.name} <br /><br /> {user.location}</h4>
                                        </td>
                                    </tr>
                                ))}
                            </table>
